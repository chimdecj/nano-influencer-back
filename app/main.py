...
def get_user_by_name(request: Request, id: int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def create_influencer(request: Request, user_id: int, influencer_item: schema.InfluencerCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def update_influencer(request: Request, influencer_id: int, influencer_item: schema.InfluencerCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def get_influencer_by_id(inf_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def get_influencer_list(skip: int = 0, limit: int = 100, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
    return crud.get_influencer_list(db=db)

@app.get("/influencer/campaigns", response_model=List[schema.Campaign], tags=["Influencers"])
def get_influencer_campaigns(influencer_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def get_social_accounts(inf_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def create_social_account(request: Request, inf_id:int, social_account: schema.SocialAccountCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def create_org(request: Request, user_id: int, org: schema.OrganizationCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def update_org(request: Request, org_id: int, org: schema.OrganizationCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def read_orgs(skip: int = 0, limit: int = 100, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
    orgs = crud.get_orgs(db, skip=skip, limit=limit)
    return orgs

@app.get("/campaign/", response_model=schema.Campaign, tags=["Campaigns"])
def get_campaign(campaign_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def read_campaigns(org_id:int, skip: int = 0, limit: int = 100, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def get_campaigns_by_status(org_id:int, status:int, skip: int = 0, limit: int = 100, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def create_campaign(request: Request, org_id:int, campaign: schema.CampaignCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def update_campaign(request: Request, campaign_id:int, campaign: schema.CampaignCreate, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def submit_campaign(request: Request, campaign_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def update_influencer_to_campaign(request: Request, campaign_id:int, influencer_ids: List[str], db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
def get_campaign_influencers(campaign_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
async def campaign_upload_image(request: Request, campaign_id:int, file: UploadFile = File(None), db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
    file.file.seek(0, 2)
...
async def campaign_delete_image(request: Request, image_id:int, db: Session = Depends(get_database_session), authorization: str = Depends(get_authorization_header)):
...
@app.post("/upload/")
async def create_upload_file(request: Request, file: UploadFile = File(None), authorization: str = Depends(get_authorization_header)):
    file.file.seek(0, 2)
    file_size = file.file.tell()
